...
crop_dummy.bool=0;
measurement_image_whole=imreadraw('D:\Projects\MATLAB Projects\Structured Light Compressive Sensing\data\Shooting - 5.5. - FER - dng\Measurements\1\mask_064.dng', crop_dummy, 'all', 'rggb');
...
[backgrounds] = imreadraw_from_directory('D:\Projects\MATLAB Projects\Structured Light Compressive Sensing\data\Shooting - 5.5. - FER - dng\Backgrounds\','.dng', crop_roi, bayer_cfa_color, plot_images.bool, 'rggb');
...
[synth_masks, synth_mask_number_of_ones, phi]=loadSyntheticMasks('D:\Projects\MATLAB Projects\Structured Light Compressive Sensing\data\1280x800 Patterns\Measurement Masks\1\','.png', crop_masks, 0);

% load calib masks and calculate number of ones in each mask
[synth_calib_masks, synth_calib_mask_number_of_ones]=loadSyntheticMasks('D:\Projects\MATLAB Projects\Structured Light Compressive Sensing\data\1280x800 Patterns\Different Percentage Masks\1. Random Pattern\1\','.png', crop_masks, 0);
